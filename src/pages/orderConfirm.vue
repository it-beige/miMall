        ...
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              <div class="addr-info" :class="{'checked' : checkedIndex === index}" @click="checkedIndex = index" v-for="(item, index) in addList" :key="index">
                ...
                <div class="action">
                  <a href="javascript:;" class="fl" @click="showEditModal(item)">
    ...
    >
      <template v-slot:body>
        <div class="edit-wrap">
          ...
          <div class="item">
            <textarea name="street" v-model="checkedItem.receiverAddress" cols="80" rows="6"></textarea>
          </div>
          <div class="item">
...
export default {
  ...
  methods: {
    ...
    // 订单结算
    orderSubmit() {
      let item = this.addList[this.checkedIndex];
      if (!item) {
